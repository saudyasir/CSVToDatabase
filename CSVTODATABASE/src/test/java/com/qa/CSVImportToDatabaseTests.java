...
public class CSVImportToDatabaseTests {
	...
	public void setUp() {
	 ...
	 /*   public boolean isDataInDatabase(String expectedValue) throws SQLException {
	        Connection connection = DriverManager.getConnection(dbUrl, username, password);
	        Statement stmt = connection.createStatement();
	        ResultSet rs = stmt.executeQuery("SELECT * FROM your_table WHERE column_name = '" + expectedValue + "'");
